...
import type { NotificationDto } from '../../../../api/notification-hr.api';
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-4 flex-1">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center text-3xl flex-shrink-0">
                {getTypeIcon(notification.type || 'ANNOUNCEMENT')}
              </div>
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">{notification.title}</h2>
                <div className="flex flex-wrap gap-2">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getPriorityColor(notification.priority || 'NORMAL')}`}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="font-medium text-gray-900">
                  {new Date(notification.createdAt || notification.sentDate || new Date().toISOString()).toLocaleString('vi-VN')}
                </div>
              </div>
