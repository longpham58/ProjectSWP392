    ...
    <div className="container">
      <div className="left-section">
        <div className="welcome-content">
          <h1 className="welcome-title">Welcome to ITMS</h1>
          <p className="welcome-subtitle">Your Learning Starts Here</p>
          <p className="tagline">Step into your training room</p>
        </div>
      </div>
        ...
        <div className="login-container">
          ...
          <div className="social-login">
            ...
            <div className="social-icons">
              <button className="social-icon google" type="button" disabled>
